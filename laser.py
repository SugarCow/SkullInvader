...
class Laser(Sprite):
    ...
    alien_laser_images = [pg.transform.rotozoom(pg.image.load(f'images/red_projectile_down{n+1}.png'), 0, 1) for n in range(2)]
    ship_laser_images = [pg.transform.rotozoom(pg.image.load(f'images/Purple_energy_ball{n+1}.png'), 0, 1) for n in range(2)]
